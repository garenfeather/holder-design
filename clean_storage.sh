...
clean_files "$STORAGE_DIR/inside_stroke" "*.psd" "Stroke内部PSD文件(v1)"
clean_files "$STORAGE_DIR/inside_stroke_v2" "*.psd" "Stroke内部PSD文件(v2)"
...
mkdir -p "$STORAGE_DIR/inside_stroke"
mkdir -p "$STORAGE_DIR/inside_stroke_v2"
